(function(){
    ...
    for(var i=20;i<=1000;i++){
        ...
        if(len === 2) {
            ...
            ans = ans + pos2(num1,num2) + pos3(num3);
        }else {
    ...
    function pos3(n3) {
        switch(n3){
            case 1:
                cha =  num.one + num.hundred + 3;
                break;
            case 2:
                cha =  num.two + num.hundred + 3;
                break;
            case 3:
                cha =  num.three + num.hundred + 3;
                break;
            case 4:
                cha =  num.four + num.hundred + 3;
                break;
            case 5:
                cha =  num.five + num.hundred + 3;
                break;
            case 6:
                cha =  num.six + num.hundred + 3;
                break;
            case 7:
                cha =  num.seven + num.hundred + 3;
                break;
            case 8:
                cha =  num.eight + num.hundred + 3;
                break;
            case 9:
                cha =  num.nine + num.hundred + 3;
                break;
            default: console.log("error");
                break;
        }
